...
SELECT s.id as website_id, s.name as site_title, s.jahia, s.wordpress, b.id as browser_id, b.os, b.name, b.version, l.date, u.id as user_id, u.first_name, u.last_name, l.status 
FROM logs l 
